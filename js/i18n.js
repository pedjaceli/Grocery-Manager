...
const TRANSLATIONS = {
  fr: {
    ...
    ob_step2_text_mobile: 'Pour enregistrer un revenu, appuie sur le bouton <strong>"+"</strong> en haut à droite.',
    ...
    ob_balance_title:  'Étape 4 — Solde du compte',
    ob_balance_text:   'En haut du <strong>Dashboard</strong>, une carte violette affiche ton <strong>solde bancaire simulé</strong> en temps réel.',
    ob_balance_s1:     'Clique sur <strong>✏️</strong> pour entrer ton solde actuel',
    ob_balance_s2:     'Tes <strong>revenus</strong> s\'ajoutent automatiquement',
    ...
    ob_dep_inv_desc:   'Crée des factures avec plusieurs articles (produit, quantité, prix total). Idéal pour les achats détaillés.',
    ob_dep_exp_title:  'Dépenses simples',
    ob_dep_exp_desc:   'Enregistre rapidement une dépense avec un montant, une catégorie et une description.',
    ob_dep_tip:        'L\'onglet <strong>Par produit</strong> agrège tous tes achats par article — filtre par mois ou par année pour voir combien tu dépenses sur chaque produit.',
    ...
    ob_step4_tip:      'Bonne gestion de tes finances !',
    ob_btn_skip:       'Passer',
  ...
  en: {
    ...
    ob_step2_text_mobile: 'To record a revenue, tap the <strong>"+"</strong> button at the top right.',
    ...
    ob_balance_title:  'Step 4 — Account balance',
    ob_balance_text:   'At the top of the <strong>Dashboard</strong>, a purple card shows your <strong>simulated bank balance</strong> in real time.',
    ob_balance_s1:     'Click <strong>✏️</strong> to enter your current balance',
    ob_balance_s2:     'Your <strong>revenues</strong> are added automatically',
    ...
    ob_step4_tip:      'Enjoy managing your finances!',
    ob_btn_skip:       'Skip',
